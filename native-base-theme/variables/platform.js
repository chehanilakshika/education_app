...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#D81B60' : '#D81B60',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#D81B60' : '#D81B60',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#F48FB1' : '#F48FB1',
  ...
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#D81B60' : '#D81B60',
